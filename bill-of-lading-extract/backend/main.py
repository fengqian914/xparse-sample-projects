# -*- coding: utf-8 -*-
"""
Bill of Lading Extract - FastAPI Backend
...
app = FastAPI(title="Bill of Lading Extract API")
...
async def parse_document(file: UploadFile = File(...)):
    """Parse a bill of lading file using TextIn official API. Returns markdown + pages."""
...
async def extract(req: ExtractRequest):
    """Route bill of lading extraction to AI Gateway (if configured) or OpenAI-compatible fallback."""
