# -*- coding: utf-8 -*-
"""
Bank Statement Extract - FastAPI Backend
...
app = FastAPI(title="Bank Statement Extract API")
...
async def parse_document(file: UploadFile = File(...)):
    """Parse a bank statement file using TextIn official API. Returns markdown + pages."""
...
async def extract(req: ExtractRequest):
    """Route bank statement extraction to AI Gateway (if configured) or OpenAI-compatible fallback."""
